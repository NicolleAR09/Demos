...
square2 = visual.Rect(win=mywin, width=200, height=200, pos=[-633,334], fillColor=(1,1,1))
...
while True: #this creates a never-ending loop
    ...
    #10Hz -> 20 impulses per second, 0.025 seconds each black and white 
    #1: 0.025 seconds

    rand = random.randint(5, 10) #Wait random seconds

    for x in range(0,1): #repeat 10 times
        ...
        for j in range(0,5): #for 5 seconds 
            ...
            for i in range(0,20):
                ...
                mywin.flip()
                core.wait(0.05) #show square for 0.025 second
                mywin.flip()  # flip without drawing
                core.wait(0.05) #Wait 0.025 seconds 
